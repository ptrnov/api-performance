...
use api\modules\dashboard\models\Comparison;
 ...
 */
class ComparisonController extends ActiveController
{	
	/**
	  * Source Database declaration 
	 */
    public $modelClass = 'api\modules\dashboard\models\Comparison';
	// public $serializer = [
	...
	public function actionKombobox1(){
		// \Yii::$app->response->format = \yii\web\Response::FORMAT_JSON;
		// $paramsBody	= Yii::$app->getRequest()->bodyParams;
		$searchModel  = new Comparison();
		$dataProvider = $searchModel->searchKombobox1();

		return ['result'=>$dataProvider];
	}
	
	public function actionKombobox2(){
		\Yii::$app->response->format = \yii\web\Response::FORMAT_JSON;
		$paramsBody	= Yii::$app->getRequest()->bodyParams;
		$kdStation		= isset($paramsBody['kdStation'])!=''?$paramsBody['kdStation']:'';
		$searchModel  	= new Comparison();
		$dataProvider 	= $searchModel->searchKombobox2($kdStation);
